...
type WWApiClient interface {
	...
	// IpmiPower gets or sets the power state for a set of nodes.
	IpmiPower(ctx context.Context, in *IpmiPowerRequest, opts ...grpc.CallOption) (*IpmiResponse, error)
...
type WWApiServer interface {
	...
	// IpmiPower gets or sets the power state for a set of nodes.
	IpmiPower(context.Context, *IpmiPowerRequest) (*IpmiResponse, error)
	// IpmiSdr gets the SDR for a set of nodes.
...
func (UnimplementedWWApiServer) IpmiPower(context.Context, *IpmiPowerRequest) (*IpmiResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IpmiPower not implemented")
}
...
func _WWApi_IpmiPower_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IpmiPowerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WWApiServer).IpmiPower(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var WWApi_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "IpmiPower",
			Handler:    _WWApi_IpmiPower_Handler,
		},
		{
			MethodName: "IpmiSdr",
